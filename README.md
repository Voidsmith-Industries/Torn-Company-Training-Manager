...
## v1.2.6 userscript icon

v1.2.6 adds the dedicated Voidsmith briefcase icon to the userscript metadata. Training behavior and the website-hosted install/update path are unchanged from v1.2.5.
